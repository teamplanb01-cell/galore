                ...
                if "rank" in group:
                    if "projector" not in state:
                        if group['dim'] <=2:
                            ...
                            if GaLoreProjectorTensor is None:
                                raise ModuleNotFoundError(
                                    "GaLoreProjectorTensor requires the optional dependency 'tensorly'. "
                                    "Install tensorly to use GaLore on tensors with dim > 2."
                                )
